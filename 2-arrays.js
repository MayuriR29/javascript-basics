...
function sumEvenNumbers(array) {
    const evenNumberArr=evenNumbersOnly(array);
    return sum(evenNumberArr);
}
...
function sortedUnion(arr1, arr2) {
    ...
    sortArr= arr1.concat(...arr2).sort();
    return sortArr.sort(function(a, b){return a-b});
}
